...
gmd(
  ...
  async (from, Guru, conText) => {
    ...
    if (!q) return reply("❌ Provide a channel JID!\nExample: `.addchannel 120363408668355773@newsletter`");
    const jid = q.trim();
...
gmd(
  ...
  async (from, Guru, conText) => {
    ...
    if (!q) return reply("❌ Provide a channel JID!\nExample: `.removechannel 120363408668355773@newsletter`");
    const jid = q.trim();
...
gmd(
  ...
  async (from, Guru, conText) => {
    ...
    if (!q) return reply("❌ Provide your channel JID!\nExample: `.setchanneljid 120363408668355773@newsletter`");
    const jid = q.trim();
